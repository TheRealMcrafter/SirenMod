...
public class SirenMod {
	...
	public static CreativeTabs SirenModCreativeTab = new SirenModCreativeTab(CreativeTabs.getNextID(),
			"TheRealMcrafter's Siren Mod");
	@SidedProxy(clientSide = "TheRealMcrafter.SirenMod.client.SirenModClientProxy", serverSide = "TheRealMcrafter.SirenMod.common.SirenModCommonProxy") // Tells
																																						// Forge
																																						// the
																																						// location
																																						// of
	...
	public void load(FMLInitializationEvent event) {
		...
		/*
		 * GameRegistry.addRecipe(new ItemStack(SirenMod.Wrench), " I ", " II",
		 * "I  ", 'I', Items.iron_ingot);
		 * 
		 * GameRegistry.addRecipe(new ItemStack(SirenMod.IntegratedCircuit),
		 * "RSR", "SES", "RSR", 'R', Items.redstone, 'S', SirenMod.SiliconShard,
		 * 'E', Items.ender_pearl);
		 * 
		 * GameRegistry.addRecipe(new ItemStack(SirenMod.Speaker), "III", "ICI",
		 * "III", 'I', Items.iron_ingot, 'C', SirenMod.IntegratedCircuit);
		 * 
		 * 
		 * GameRegistry.addRecipe(new ItemStack(SirenMod.GeneralSirenItem),
		 * "SIS", "PPP", 'I', Items.iron_ingot, 'S', SirenMod.Speaker, 'P',
		 * Blocks.stone_slab);
		 * 
		 * GameRegistry.addRecipe(new ItemStack(SirenMod.NuclearSiren), "SI ",
		 * " I ", "PPP", 'I', Items.iron_ingot, 'S', SirenMod.Speaker, 'P',
		 * Blocks.stone_slab);
		 * 
		 * GameRegistry.addRecipe(new ItemStack(SirenMod.AmericanSignalT121),
		 * "SIS", "SIS", "PPP", 'I', Items.iron_ingot, 'S', SirenMod.Speaker,
		 * 'P', Blocks.stone_slab);
		 * 
		 * GameRegistry.addRecipe(new ItemStack(SirenMod.BurglarSiren), "III",
		 * "ISI", "III", 'I', Items.iron_ingot, 'S', SirenMod.Speaker);
		 * 
		 * GameRegistry.addRecipe(new ItemStack(SirenMod.FireAlarm), "ISI",
		 * "IGI", "III", 'I', Items.iron_ingot, 'S', SirenMod.Speaker, 'G',
		 * Blocks.glass);
		 * 
		 * GameRegistry.addRecipe(new ItemStack(SirenMod.SirenPole), "I", "I",
		 * "I", 'I', Items.iron_ingot);
		 * 
		 */
