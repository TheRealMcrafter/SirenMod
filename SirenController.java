...
public class SirenController extends BlockContainer {
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float blockPosX,
			float blockPosY, float blockPosZ) {
		if (!world.isRemote) {
			SirenControllerTileEntity tile = (SirenControllerTileEntity) world.getTileEntity(x, y, z);
			...
			if (tile.getRenderValue() == 0) {
				if (world.getBlockMetadata(x, y, z) == 5) {
					if (blockPosX < 0.87 && blockPosX > 0.72 && blockPosY == 0.75 && blockPosZ < 0.8
							&& blockPosZ > 0.74) {
						tile.buttonPress("red");
					} else if (blockPosX < 0.87 && blockPosX > 0.72 && blockPosY == 0.75 && blockPosZ < 0.25
							&& blockPosZ > 0.16) {
						tile.buttonPress("green");
					} else if (blockPosX < 0.87 && blockPosX > 0.72 && blockPosY == 0.75 && blockPosZ < 0.56
							&& blockPosZ > 0.43) {
						tile.buttonPress("blue");
					}
				} else if (world.getBlockMetadata(x, y, z) == 2) {
					if (blockPosX < 0.81 && blockPosX > 0.75 && blockPosY == 0.75 && blockPosZ < 0.28
							&& blockPosZ > 0.13) {
						tile.buttonPress("red");
					} else if (blockPosX < 0.24 && blockPosX > 0.19 && blockPosY == 0.75 && blockPosZ < 0.26
							&& blockPosZ > 0.13) {
						tile.buttonPress("green");
					} else if (blockPosX < 0.56 && blockPosX > 0.43 && blockPosY == 0.75 && blockPosZ < 0.27
							&& blockPosZ > 0.13) {
						tile.buttonPress("blue");
					}
				} else if (world.getBlockMetadata(x, y, z) == 4) {
					if (blockPosX < 0.27 && blockPosX > 0.13 && blockPosY == 0.75 && blockPosZ < 0.24
							&& blockPosZ > 0.18) {
						tile.buttonPress("red");
					} else if (blockPosX < 0.27 && blockPosX > 0.13 && blockPosY == 0.75 && blockPosZ < 0.81
							&& blockPosZ > 0.75) {
						tile.buttonPress("green");
					} else if (blockPosX < 0.27 && blockPosX > 0.13 && blockPosY == 0.75 && blockPosZ < 0.56
							&& blockPosZ > 0.44) {
						tile.buttonPress("blue");
					}
				} else if (world.getBlockMetadata(x, y, z) == 3) {
					if (blockPosX < 0.25 && blockPosX > 0.18 && blockPosY == 0.75 && blockPosZ < 0.87
							&& blockPosZ > 0.73) {
						tile.buttonPress("red");
					} else if (blockPosX < 0.80 && blockPosX > 0.75 && blockPosY == 0.75 && blockPosZ < 0.87
							&& blockPosZ > 0.75) {
						tile.buttonPress("green");
					} else if (blockPosX < 0.56 && blockPosX > 0.44 && blockPosY == 0.75 && blockPosZ < 0.87
							&& blockPosZ > 0.75) {
						tile.buttonPress("blue");
					}
				}
