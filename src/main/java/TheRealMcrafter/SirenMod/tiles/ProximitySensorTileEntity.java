...
public class ProximitySensorTileEntity extends TileEntity {
	...
	public void updateEntity(){
		if (!worldObj.isRemote){
			List l = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, AxisAlignedBB.getBoundingBox(this.xCoord - 10, this.yCoord - 10, this.zCoord - 10, this.xCoord + 10, this.yCoord + 10, this.zCoord + 10));
			if (l.isEmpty()){
