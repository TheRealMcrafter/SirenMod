        ...
        if (!player.canPlayerEdit(x, y, z, side, itemstack)){
            ...
            if (world.canPlaceEntityOnSide(this.blockToPlace, x, y, z, false, side, (Entity)null, itemstack)){
                ...
                if (world.setBlock(x, y, z, this.blockToPlace, i1, 3)){
                    ...
                    world.playSoundEffect((double)((float)x + 0.5F), (double)((float)y + 0.5F), (double)((float)z + 0.5F), this.blockToPlace.stepSound.func_150496_b(), (this.blockToPlace.stepSound.getVolume() + 1.0F) / 2.0F, this.blockToPlace.stepSound.getPitch() * 0.8F);
                    --itemstack.stackSize;
                }
            }
...
/*@Override
@SideOnly(Side.CLIENT)
	public IIcon getIcon(ItemStack stack, int meta){
	switch(this.getDamage(stack)){
	case 0:
		return iconArray[0];
	case 1:
