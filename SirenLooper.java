...
import TheRealMcrafter.SirenMod.TileEntity.SmokeDetectorTileEntity;
...
public class SirenLooper extends MovingSound {
	...
	public void update() {
		if (tile instanceof GeneralSirenTileEntity) {
			...
			if (((AmericanSignalT121TileEntity) tile).isShouldStop()
					|| ((AmericanSignalT121TileEntity) tile).isInvalid()) {
				this.donePlaying = true;
			}
		} else if (tile instanceof SmokeDetectorTileEntity) {
