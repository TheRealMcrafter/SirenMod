...
public class SirenControllerRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		...
		tileentity.getWorldObj().scheduleBlockUpdate((int) tileentity.xCoord, (int) tileentity.yCoord,
				(int) tileentity.zCoord, tileentity.getBlockType(), 20);
		...
		if (tile.getRenderValue() == 0) {
			if (tile.state.equals("")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/SirenController/SirenControllerNoSiren.png"));
				this.bindTexture(textures);
			} else if (tile.state.equals("red")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/SirenController/SirenControllerDisarmed.png"));
				this.bindTexture(textures);
			} else if (tile.state.equals("green")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/SirenController/SirenControllerArmed.png"));
				this.bindTexture(textures);
			} else if (tile.state.equals("blue")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/SirenController/SirenControllerTesting.png"));
				this.bindTexture(textures);
			} else if (tile.state.equals("waiting")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/SirenController/SirenControllerWaiting.png"));
				this.bindTexture(textures);
			}
			...
			if (tile.state.equals("")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/MountedSirenController/MountedSirenControllerNoSiren.png"));
				this.bindTexture(textures);
			} else if (tile.state.equals("red")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/MountedSirenController/MountedSirenControllerDisarmed.png"));
				this.bindTexture(textures);
			} else if (tile.state.equals("green")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/MountedSirenController/MountedSirenControllerArmed.png"));
				this.bindTexture(textures);
			} else if (tile.state.equals("blue")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/MountedSirenController/MountedSirenControllerTesting.png"));
				this.bindTexture(textures);
			} else if (tile.state.equals("waiting")) {
				ResourceLocation textures = (new ResourceLocation(
						"sirenmod:textures/blocks/MountedSirenController/MountedSirenControllerWaiting.png"));
				this.bindTexture(textures);
			}
