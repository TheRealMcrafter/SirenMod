...
public class SirenModPacketDispatcher {
	...
	// credit to coolAlias for his awesome tutorial on packets, my entire
	// framework is based on his tutorial.
	/**
	...
	public static final void registerPackets() {
		SirenModPacketDispatcher.registerMessage(SirenModOpenGuiMessage.Handler.class, SirenModOpenGuiMessage.class,
				Side.SERVER);
		SirenModPacketDispatcher.registerMessage(SirenModPlayLoopedSoundMessage.Handler.class,
				SirenModPlayLoopedSoundMessage.class, Side.CLIENT);
		SirenModPacketDispatcher.registerMessage(SirenModUpdateSirenColorMessage.Handler.class,
				SirenModUpdateSirenColorMessage.class, Side.SERVER);
		SirenModPacketDispatcher.registerMessage(SirenModStopSoundsMessage.Handler.class,
				SirenModStopSoundsMessage.class, Side.CLIENT);
		SirenModPacketDispatcher.registerMessage(SirenModSpawnParticleMessage.Handler.class,
				SirenModSpawnParticleMessage.class, Side.CLIENT);
		SirenModPacketDispatcher.registerMessage(SirenModPlaySoundMessage.Handler.class, SirenModPlaySoundMessage.class,
				Side.CLIENT);
		SirenModPacketDispatcher.registerMessage(SirenModUpdateValueToClientMessage.Handler.class,
				SirenModUpdateValueToClientMessage.class, Side.CLIENT);
		SirenModPacketDispatcher.registerMessage(SirenModUpdateValueToServerMessage.Handler.class,
				SirenModUpdateValueToServerMessage.class, Side.SERVER);
	...
	public static final void sendToAllAround(IMessage message, EntityPlayer player, double range) {
		SirenModPacketDispatcher.sendToAllAround(message, player.worldObj.provider.getDimensionId(), player.posX,
