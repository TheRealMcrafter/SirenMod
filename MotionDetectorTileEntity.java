...
public class MotionDetectorTileEntity extends TileEntity {
	...
	public void updateEntity() {
		if (!worldObj.isRemote) {
			...
			case 5:
				list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class,
						AxisAlignedBB.getBoundingBox(this.xCoord, this.yCoord - 3, this.zCoord - 10, this.xCoord + 10,
								this.yCoord + 3, this.zCoord + 10));
				break;
			case 2:
				list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class,
						AxisAlignedBB.getBoundingBox(this.xCoord - 10, this.yCoord - 3, this.zCoord - 10,
								this.xCoord + 10, this.yCoord + 3, this.zCoord));
				break;
			case 4:
				list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class,
						AxisAlignedBB.getBoundingBox(this.xCoord - 10, this.yCoord - 3, this.zCoord - 10, this.xCoord,
								this.yCoord + 3, this.zCoord + 10));
				break;
			case 3:
				list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class,
						AxisAlignedBB.getBoundingBox(this.xCoord - 10, this.yCoord - 3, this.zCoord, this.xCoord + 10,
								this.yCoord + 3, this.zCoord + 10));
				break;
			default:
				list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class,
			...
			if (list.isEmpty()) {
				...
				for (int i = 0; i < list.size(); i++) {
					...
					if (this.canEntityBeSeen(entity)) {
						if (props.oldX - entity.posX > 0.07D || props.oldX - entity.posX < -0.07D
								|| props.oldY - entity.posY > 0.02D || props.oldY - entity.posY < -0.02D
								|| props.oldZ - entity.posZ > 0.07D || props.oldZ - entity.posZ < -0.07D) {
	...
	public boolean canEntityBeSeen(Entity entity) {
		return this.worldObj.rayTraceBlocks(
				Vec3.createVectorHelper(this.xCoord + 0.5D, this.yCoord + 0.5D, this.zCoord + 0.5D),
				Vec3.createVectorHelper(entity.posX, entity.posY + (double) entity.getEyeHeight(),
						entity.posZ)) == null;
	}
